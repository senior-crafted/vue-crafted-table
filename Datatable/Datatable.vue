<template>
    <div>
        <div v-if="!isLoaded" class="card p-0 border text-center" ref="datatable">
        ...
        <div v-if="isLoaded" class="datatable-block-container card p-0 border" ref="datatable" :style="style">
            <div
        ...
        <b-pagination v-if="hasPagination" v-model="currentPage" :total-rows="totalRows" :per-page="perPage" />
    </div>
</template>
